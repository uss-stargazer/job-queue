...
export const getProjectPool = async (
  ...
  return await makeGistData(
    ...
    data,
    'projectpool.json',
    makeGistConflictHandler(ProjectPoolSchema, editor),
    handleInvalidGist,
    "JSON to keep track of `projectpool` data for this user's job-queue implementation (this is probably autogenerated).",
  );
};
